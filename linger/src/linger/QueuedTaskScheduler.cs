...
namespace System.Threading.Tasks.Schedulers
{
    ...
    public sealed class QueuedTaskScheduler : TaskScheduler, IDisposable
    {
        ...
        private int DebugTaskCount
        {
            get
            {
                return (_targetScheduler != null
                            ...
                            : (IEnumerable<Task>) _blockingTaskQueue).Count(t => t != null);
            }
        }
        ...
        public void Dispose()
        {
            ...
            // [DC]: Called out by code analysis, but will likely mess with shutdown
        ...
        private void RemoveQueueNeedsLock(QueuedTaskSchedulerQueue queue)
        {
