...
{
    [TestFixture]
    public class SqlServerDatabaseJobRepositoryTests : SqlServerFixture
    {
        private readonly DatabaseJobRepositoryTests _repositoryTests;

        public SqlServerDatabaseJobRepositoryTests()
        {
        ...
        {
            return new DatabaseJobRepository(DatabaseDialect.SqlServer, () => UnitOfWork.Current);
        }
    }
}