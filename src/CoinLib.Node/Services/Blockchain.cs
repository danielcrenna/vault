...
namespace CoinLib.Node.Services
{
	public class Blockchain : ICurrencyBlockchain
	{
        ...
        public IEnumerable<CurrencyBlock> StreamAllBlocks(bool forwards = true, int startingAt = 0)
        {
            return _blocks.StreamAllBlocks(forwards, startingAt);
        }

		public IEnumerable<BlockObject> StreamAllBlockObjects(bool forwards = true, int startingAt = 0)
		{
