...
{
    // http://stackoverflow.com/questions/6702172/protobuf-net-v2-type-meta
    // http://stackoverflow.com/questions/6088004/how-runtimetypemodel-can-be-used-to-associate-protoinclude-with-a-type-in-protob
    ...
    public class ReflectionRuntimeTypeModel
    {
        ...
        public static void AddType<T>(RuntimeTypeModel model, params Assembly[] assemblies)
        {
            ...
            AddSubTypes(type, meta, model, assemblies.ToList());
        }

        private static void AddSubTypes(Type parentType, MetaType metaType, RuntimeTypeModel typeModel, IList<Assembly> assemblies)
        {
