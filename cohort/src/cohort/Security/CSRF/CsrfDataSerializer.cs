...
{
	internal class CsrfDataSerializer
	{
		...
		public virtual CsrfData Deserialize(string serializedToken)
		{
		...
		private static class FormatterGenerator
		{
			...
			[SuppressMessage("Microsoft.Performance", "CA1810:InitializeReferenceTypeStaticFieldsInline", Justification = "This type must not be marked 'beforefieldinit'.")]
