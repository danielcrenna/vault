...
namespace MonoTouch.Dialog
{
	...
	public class DialogViewController : UITableViewController
	{
		...
		public DialogViewController (NSCoder coder) : base(coder)
		{
		...
		public CustomTableView CustomTableView
		{
			get
			{
				return tableView;	
		...
		public void ReloadComplete ()
		{
			...
			// Don't reset this to 0, set it to the new 0, which is 44...
		...
		public override void DidRotate (UIInterfaceOrientation fromInterfaceOrientation)
		{
			...
			if (refreshView != null) {
				...
				if(Util.IsLandscape() && Util.IsPhone())
				{
					refreshView.Frame.Y -= 20;
				}
			}
		...
		{
			const float yboundary = 65 + 44; /* Setting controls the reset point of the refresh view */
		...
		{
			this.TableView.ScrollRectToVisible(new RectangleF(0, 0, 1, 1), false);
		}
